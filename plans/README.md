...
| [147](archive/147-sync-queue-cache-and-prune.md)                    | Sync queue: cache de lecturas + prune de entradas terminales           | P2        | S-M      | —          | DONE — 2026-08-23 (`4802d712`, worktree `advisor/147-sync-queue-cache-and-prune`; merged a main `33e59eee`)                  |
