...
| [145](archive/145-dev-tool-reconciliation.md)                       | Reconciliar dev-tools: decisión stryker + changesets 3.0               | P2        | S-M      | 140        | DONE — 2026-08-27 (`ce1198aa`, direct on main; review approved)                                                              |
...
| [149](archive/149-storefront-interaction-perf.md)                   | Perf de interacción storefront (companion cache + reorder gating)      | P2        | S        | —          | DONE — 2026-08-25 (`c40b5b3c`, worktree `advisor/149-storefront-interaction-perf`; merged a main `e2a8ceee`)                 |
| [150](archive/150-memoize-admin-stable-data.md)                     | Memoizar datos estables del admin (OpenAPI, storefront)                | P2        | S        | —          | DONE — 2026-08-25 (`96ecccfc`, worktree `advisor/150-memoize-admin-stable-data`; merged a main `2c17b998`)                   |
| [151](archive/151-finish-client-unification.md)                     | Completar plan 115: 11 fetch sueltos → ContentManagerClient            | P2        | S        | —          | DONE — 2026-08-25 (`0f17db5d`, worktree `advisor/151-finish-client-unification`; merged a main `81462567`)                   |
| [152](archive/152-repository-base-class.md)                         | Base compartida de repositorios JSON + writer atómico multi-target     | P2        | M        | —          | DONE — 2026-08-25 (`8353acdb`, worktree `advisor/152-repository-base-class`; merged a main `35d316c4`)                       |
| [153](archive/153-consolidate-route-orchestration.md)               | Consolidar orquestación de rutas (helper catalog-command)              | P2        | M        | 128, 141   | DONE — 2026-08-26 (`f32a5d42`, worktree `advisor/153-consolidate-route-orchestration`; merged a main `36445239`)             |
| [154](archive/154-unify-validation-layers.md)                       | Unificar las 4 capas de validación en zod canónico                     | P3        | L        | —          | DONE — 2026-08-28 (`4518c063`, direct on main; review approved)                                                              |
| [155](archive/155-retire-src-js-zombie-surface.md)                  | Retirar src/js zombie (extraer funciones vivas primero)                | P2        | M        | 140        | DONE — 2026-08-27 (`20a92556`, direct on main; review approved)                                                              |
| [156](archive/156-image-pipeline-consolidation.md)                  | Consolidar pipeline de imágenes + portar renderer OG a Node            | P3        | L        | —          | DONE — 2026-08-28 (`113c8edb`, direct on main; review approved)                                                              |
| [157](archive/157-remove-vestigial-surfaces.md)                     | Remover superficies vestigiales (cypress, panel, config Python muerta) | P2        | S        | —          | DONE — 2026-08-26 (`11303f47`, direct on main; review approved)                                                              |
| [158](archive/158-split-changes-routes.md)                          | Split de changes.ts (1.076 líneas) en 3 módulos                        | P3        | M        | —          | DONE — 2026-08-26 (`a9e97ffa`, direct on main; review approved)                                                              |
| [159](archive/159-remove-inert-overrides.md)                        | Quitar overrides inertes de astro-poc                                  | P3        | S        | —          | DONE — 2026-08-26 (`99f164ed`, direct on main; review approved)                                                              |
| [160](archive/160-vendored-anymatch-drift-guard.md)                 | Guard de drift dir↔tgz del anymatch vendoreado                         | P3        | M        | —          | DONE — 2026-08-26 (`9106267d`, direct on main; review approved)                                                              |
| [161](archive/161-fix-docs-config-drift.md)                         | Batch de drift docs/config (9 ítems DX + DEP-04)                       | P2        | S-M      | —          | DONE — 2026-08-26 (`fd1fcde6`, direct on main; review approved)                                                              |
| [162](archive/162-scheduled-publication-ui.md)                      | UI de publicación programada (terminar F3.1)                           | P3        | M        | 133        | DONE — 2026-08-27 (`eca18d85`, direct on main; review approved)                                                              |
| [163](archive/163-generated-typed-client-spike.md)                  | Spike: cliente tipado generado del OpenAPI/zod                         | P3        | M        | 133        | DONE — 2026-08-27 (`44153e15`, direct on main; review approved)                                                              |
| [164](archive/164-build-preview-job-spike.md)                       | Spike: job "build + preview" dentro del admin                          | P3        | M        | —          | DONE — 2026-08-28 (`f0daf4f1`, direct on main; review approved)                                                              |
| [165](archive/165-rescope-parity-gate.md)                           | Re-scope del gate de parity Python → regresión de round-trip           | P2        | S        | —          | DONE — 2026-08-27 (`0431654f`, direct on main; review approved)                                                              |
