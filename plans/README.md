...
**Regla de archivo**: al marcar un plan `DONE`, su archivo se mueve a
`plans/archive/`; los DONE recientes se conservan como registro en las tablas
de este README.
...
- **Auditoría 7 (070–085)**: casi completa. Pendientes: 083 `TODO`
  (caracterización de categorías). 082 `DONE` el 2026-08-11 (`be11b20c`).
- **Auditoría 6 (056–069)**: cola principal hacia el gate terminal **069**
  (retiro de Python). `DONE`: 056, 058, 065. `PARTIAL`: 057, 059, 062, 068.
  `TODO`: 060, 061, 063, 064, 066, 067, 069.
...
| Plan                                           | Título                                   | Priority | Effort | Depends on | Status |
| ---------------------------------------------- | ---------------------------------------- | -------- | ------ | ---------- | ------ |
| [030](030-make-product-store-durable.md)       | Hacer durable el ProductStore            | P1       | L      | —          | TODO   |
| [031](031-trim-unused-browser-runtime.md)      | Retirar Partytown y reducir Bootstrap JS | P2       | M      | 025        | TODO   |
| [038](038-spike-private-funnel-measurement.md) | Spike de medición privada del funnel     | P3       | S      | 037        | TODO   |
