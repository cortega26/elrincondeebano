...
1. **Contrast bump for muted text** _(completed 2025-10-13)_
   - Darken `.text-muted` to `#4a4f55`.
   - Regression: verify contrast on product cards & footer.
2. **HTTPS enforcement for external CTAs** _(completed)_
...
1. **Catalog filter debounce + memoization** _(completed 2025-10-13)_
   - Debounce keyup by 150 ms; cache normalized product array.
   - Measure INP before/after using DevTools.
2. **Cart offcanvas focus trap** _(completed 2025-10-13)_
...
1. **Product card markup refactor** _(completed 2025-10-14)_
