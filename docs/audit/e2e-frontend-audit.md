...
| --- | --- | --- | --- | --- | --- |
| PERF-01 | Performance | LCP above 2.5 s on home/category pages | Open | Hero images now request ≤480 px, q=75 variants + async CSS loading; rerun Lighthouse to confirm LCP drop. | 2025-10-13 |
