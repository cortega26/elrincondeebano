...
| --- | --- | --- | --- | --- | --- |
| PERF-01 | Performance | LCP above 2.5 s on home/category pages | Open | Hero images now request ≤480 px, q=75 variants. CSS kept render-blocking to avoid FOOC; explore alternative LCP wins. | 2025-10-13 |
