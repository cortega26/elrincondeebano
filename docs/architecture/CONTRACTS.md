...
| `astro-poc/dist/sitemap.xml` | exists + valid route coverage | `astro-poc/scripts/postbuild-sitemap.mjs`, `astro-poc/scripts/validate-http-contract.mjs` | `.github/workflows/ci.yml`, `.github/workflows/product-data-guard.yml` |
