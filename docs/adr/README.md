...
| `0010` | Decided — no-go (2026-08-27, plan 167) | Contrato provider-neutral de medición privada del funnel: colección desactivada por defecto; no re-litigar sin evidencia nueva.                                                                                                                                          |
