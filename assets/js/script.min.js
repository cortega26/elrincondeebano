...
(() => {
    ...
    var mainModule = moduleDefiner((moduleExports, module) => {
        ...
        const initializeApp = async () => {
            ...
            /**
            * Renderizar los artículos del carrito en la barra lateral
            */
            const renderCartItems = () => {
                ...
                cart.forEach(item => {
                    ...
                    // Contenedor principal del artículo (flex en fila y alineado verticalmente)
                    ...
                    // Contenedor del contenido textual con flex-grow para ocupar todo el espacio disponible
                    ...
                    // Calcular la ruta de la imagen dependiendo del contexto
                    ...
                    // Contenedor de la miniatura: margin-left: auto para empujar la imagen al extremo derecho
                    ...
                    // Añadir primero el contenido textual y luego la miniatura para que la imagen quede a la derecha
                    itemElement.appendChild(contentContainer);
                    itemElement.appendChild(thumbnailContainer);

                    // Añadir el elemento al contenedor general
                ...
                cartTotalElement.setAttribute('aria-label', `Total cart value: $${total.toLocaleString('es-CL')}`);
