        ...
        const initializeApp = async () => {
            ...
            const renderCartItems = () => {
                ...
                cart.forEach(item => {
                    ...
                    cartItem.appendChild(createElement("div", {}, [item.name]));

                    const quantityControls = createElement("div");
                    const decreaseBtn = createElement("button", {
                    ...
                    cartItem.appendChild(createElement("div", {}, [
                        `Precio: ${itemPrice.toLocaleString("es-CL")}`
                    ]));

                    cartItem.appendChild(createElement("div", {}, [
                        `Subtotal: ${(itemPrice * item.quantity).toLocaleString("es-CL")}`
                    ]));
                ...
                // Show/hide credit payment option based on total
                ...
                if (creditContainer) {
                    if (total >= 30000) {
                        ...
                        const creditInput = creditContainer.querySelector("input");
                        if (creditInput) {
