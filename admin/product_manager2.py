...
class ProductRepository:
    def __init__(self, file_path):
        self.file_path = "_products/" + file_path
...
class ProductManagerGUI:
    ...
    def populate_tree(self):
        ...
        for product in self.products:
            self.tree.insert("", "end", values=(product.name, product.description, product.price, product.stock, product.category))
    ...
    def add_product(self):
        ...
        tk.Label(add_window, text="Nombre:").grid(row=0, column=0, sticky=tk.W)
        name_entry = tk.Entry(add_window)
        name_entry.grid(row=0, column=1)

        tk.Label(add_window, text="Descripción:").grid(row=1, column=0, sticky=tk.W)
        description_entry = tk.Entry(add_window)
        description_entry.grid(row=1, column=1)

        tk.Label(add_window, text="Precio:").grid(row=2, column=0, sticky=tk.W)
        price_entry = tk.Entry(add_window)
        price_entry.grid(row=2, column=1)

        tk.Label(add_window, text="Stock:").grid(row=3, column=0, sticky=tk.W)
        ...
        tk.Label(add_window, text="Categoría:").grid(row=4, column=0, sticky=tk.W)
        ...
        tk.Button(add_window, text="Agregar", command=add).grid(row=5, column=0, columnspan=2, pady=5)
...
if __name__ == "__main__":
    root = tk.Tk()
    product_repository = ProductRepository("_products.json")
